...
export const ContentBlock: BlockConfig = {
  ...
  subBlocks: [
    ...
    },
    {
      ...
      type: 'file-upload',
      acceptedTypes:
        'image/*,video/*,audio/*,application/vnd.openxmlformats-officedocument.presentationml.presentation,.pptx',
      multiple: false,
    },
    {
    ...
    },
    {
      ...
      title: 'Video Enhance Source',
      type: 'short-input',
      hidden: true,
      paramVisibility: 'hidden',
    },
    {
      id: 'videoEnhanceParameters',
      title: 'Video Enhance Parameters',
      type: 'short-input',
      defaultValue: {
        resolution: '1080p',
        frameRate: 'source',
    ...
    },
    {
      ...
      title: 'Video Frame Capture Source',
      type: 'short-input',
      hidden: true,
      paramVisibility: 'hidden',
    },
    {
      id: 'videoFrameCaptureMode',
      title: 'Video Frame Capture Mode',
      type: 'short-input',
      hidden: true,
      paramVisibility: 'hidden',
    },
    {
      id: 'videoFrameCaptureTimeSeconds',
      title: 'Video Frame Capture Time',
      type: 'short-input',
      hidden: true,
      paramVisibility: 'hidden',
    },
