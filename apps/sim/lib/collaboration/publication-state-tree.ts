...
export function buildPublicationNotificationDeliveryDrafts(
  ...
  return [
    ...
    },
    {
      ...
      actionLabel: 'Queue email delivery',
      body: bodyLines.join('\n'),
      payload,
    },
    {
      ...
      channel: 'webhook',
      severity,
      title: 'Webhook provider delivery',
      detail: 'Queue a structured payload for external notification routing.',
      actionLabel: 'Queue webhook delivery',
