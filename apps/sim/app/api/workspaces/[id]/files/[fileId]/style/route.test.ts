...
vi.mock('@/lib/copilot/vfs/document-style', () => ({
  extractDocumentStyle: vi.fn(),
}))
...
import { GET } from '@/app/api/workspaces/[id]/files/[fileId]/style/route'

describe('Workspace file style route', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('hides foreign personal workspace style extraction behind 404', async () => {
    ...
    const response = await GET(
      new NextRequest('http://localhost:3000/api/workspaces/ws-hidden/files/file-1/style'),
