...
import { GET } from '@/app/api/tools/onedrive/folders/route'

describe('OneDriveFoldersAPI GET', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('hides foreign personal workspace credential folder list access', async () => {
    ...
    const response = await GET(
      new NextRequest('http://localhost:3000/api/tools/onedrive/folders?credentialId=cred123')
    )
