...
import { GET } from '@/app/api/tools/onedrive/folder/route'

describe('OneDriveFolderAPI GET', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('hides foreign personal workspace credential folder detail access', async () => {
    ...
    const response = await GET(
      new NextRequest(
        'http://localhost:3000/api/tools/onedrive/folder?credentialId=cred123&fileId=file123'
      )
    )
