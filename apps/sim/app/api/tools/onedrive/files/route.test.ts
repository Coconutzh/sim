...
import { GET } from '@/app/api/tools/onedrive/files/route'

describe('OneDriveFilesAPI GET', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('hides foreign personal workspace credential file list access', async () => {
    ...
    const response = await GET(
      new NextRequest('http://localhost:3000/api/tools/onedrive/files?credentialId=cred123')
    )
