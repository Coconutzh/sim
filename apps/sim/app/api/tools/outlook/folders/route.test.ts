...
import { GET } from '@/app/api/tools/outlook/folders/route'

describe('OutlookFoldersAPI GET', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('hides foreign personal workspace credential folders access', async () => {
    ...
    const response = await GET(
      new NextRequest('http://localhost:3000/api/tools/outlook/folders?credentialId=cred123')
    )
