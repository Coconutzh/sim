...
import { GET } from '@/app/api/tools/gmail/label/route'

describe('GmailLabelAPI GET', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('hides foreign personal workspace credential label access', async () => {
    ...
    const response = await GET(
      new NextRequest(
        'http://localhost:3000/api/tools/gmail/label?credentialId=cred123&labelId=INBOX'
      )
    )
