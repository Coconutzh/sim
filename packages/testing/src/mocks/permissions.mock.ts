...
export const permissionsMock = {
  ...
  isActiveWorkspaceAccessError: permissionsMockFns.mockIsActiveWorkspaceAccessError,
  getUserEntityPermissions: permissionsMockFns.mockGetUserEntityPermissions,
  listAccessibleWorkspaceIds: permissionsMockFns.mockListAccessibleWorkspaceIds,
