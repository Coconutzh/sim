...
if (-not $OutputDir) {
  $OutputDir = Join-Path $repoRoot "imgs\basketball-motions\mixamo-skinned-$Format"
}
...
$scriptPath = Join-Path $repoRoot "scripts\basketball-motions\mixamo_skin_to_motion.py"
